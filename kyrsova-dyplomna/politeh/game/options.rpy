...
define config.name = _("Політех. Шлях до успіху")
...
define gui.about = _p("""
                      Розробляла гру Сайко Галина. 
                      
                      Сюжет придумувався на ходу. 
...
define config.save_directory = "politeh-1585903920"
